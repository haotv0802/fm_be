...
public class VIBCrawler implements IBankPromotionCrawler {
  ...
  private final int INSTALLMENT_CRAWLING_OPTION = 0;
...
//            e.printStackTrace();
   ...
   * @throws InterruptedException
   */
  private List<PromotionCrawlerModel> doCrawling(Integer cateID, String url, Integer craling_option) throws InterruptedException {
