...
public class ManagedDataSourceProxy implements DataSource {
    ...
    private static final Logger logger = LogManager.getLogger(ManagedDataSourceProxy.class);
    ...
    public Connection getConnection() throws SQLException {
        ...
        if (conn != null) {
            logger.debug("Providing bound connection: " + conn);
        } else {
            conn = ds.getConnection();
            logger.debug("Providing unbound connection: " + conn);
        }
